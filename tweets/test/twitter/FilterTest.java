...
public class FilterTest {
     ...
     * not empty list
     * 
     * username :same,case insensitive,not match
     */
    @Test
    ...
    @Test
    public void testWrittenByNotMatch() {
        List<Tweet> writtenBy = Filter.writtenBy(Arrays.asList(tweet1, tweet2), "blyssa");
        assertTrue("expected empty list",writtenBy.isEmpty());
    }
  ...
  * include tweet/not include/edge   
  */
    @Test
    ...
    public void testInTimespanMultipleTweetsNoResults() {
        Instant testStart = Instant.parse("2016-02-17T11:00:30Z");
        Instant testEnd = Instant.parse("2016-02-17T12:00:00Z");
    ...
    @Test
    public void testInTimespanEdge() {
     ...
     * empty list/nonempty
     * contain/not/case insensitivity
     */
    @Test
    ...
    @Test
    public void testContainingNot() {
        List<Tweet> containing = Filter.containing(Arrays.asList(tweet1, tweet2), Arrays.asList("king"));
        
        assertTrue("expected empty list",containing.isEmpty());
    }
    
    @Test
    public void testContainingCaseInsensitivie(){
